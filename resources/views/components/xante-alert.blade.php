@props([
    'variant' => 'info', // exito, advertencia, peligro, informacion
    'dismissible' => false
])

@php
$baseClasses = 'p-4 rounded-lg border-l-4';

$variants = [
    'success' => 'bg-[#C9D534]/10 border-l-[#C9D534] text-[#342970]',
    'warning' => 'bg-[#FFD729]/10 border-l-[#FFD729] text-[#342970]',
    'danger' => 'bg-[#D63B8E]/10 border-l-[#D63B8E] text-[#D63B8E]',
    'info' => 'bg-[#62257D]/10 border-l-[#62257D] text-[#62257D]'
];
